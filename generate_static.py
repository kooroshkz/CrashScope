#!/usr/bin/env python3
"""
Generate static snapshot of incidents for GitHub Pages deployment
"""
...
def fetch_and_process_incidents():
    """Fetch and fully process all incidents"""
    ...
    # Process each incident with full enrichment
    processed_incidents = []
    
    for i, incident in enumerate(all_incidents, 1):
        try:
            print(f"Processing incident {i}/{len(all_incidents)}...")
...
def main():
    ...
    incidents = fetch_and_process_incidents()
    ...
    output_file = output_dir / 'incidents_data.json'
